...
class Http {
    ...
    static function exec(string $method, string $url, array $data = null, array $headers = null, int $timeout=3):bool {
        ...
        if (isset($headers["APIKEY"])) curl_setopt(self::$ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
    ...
    static function response(bool $assoc=true) {
        return json_decode(self::$buffer, $assoc);
    }
