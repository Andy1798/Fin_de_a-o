...
<div id="scrollToTopBtn" title="Volver arriba">
    ...
    <div class="categories-wrapper">
        <a href="/catalog/category/4" class="category-box" style="background-image: url('/static/img/img_category/aceite.jpg');">
            <span class="category-title">Aceites</span>
        </a>
        <a href="/catalog/category/2" class="category-box" style="background-image: url('/static/img/img_category/motor.jpeg');">
            <span class="category-title">Motores</span>
        </a>
        <a href="/catalog/category/3" class="category-box" style="background-image: url('/static/img/img_category/suspension.jpeg');">
            <span class="category-title">Suspensiones</span>
        </a>
        <a href="/catalog/category/6" class="category-box" style="background-image: url('/static/img/img_category/filtro.jpeg');">
            <span class="category-title">Filtros</span>
        </a>
        <a href="/catalog/category/7" class="category-box" style="background-image: url('/static/img/img_category/bateria.jpg');">
            <span class="category-title">Baterías</span>
        </a>
        <a href="/catalog/category/5" class="category-box" style="background-image: url('/static/img/img_category/neumatico.jpeg');">
